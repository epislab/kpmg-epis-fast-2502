...
from com.epislab.design_pattern.creational.builder.query_builder import QueryBuilder
from com.epislab.design_pattern.creational.singleton.db_singleton import db_singleton
